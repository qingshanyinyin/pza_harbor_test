...
# 记录文件
build_results_file = "./py/build_results.csv" # build镜像
push_results_file = "./py/push_results.csv"   # push镜像
pull_results_file = "./py/pull_results.csv"   # pull镜像
delete_local_results_file = "./py/delete_local_results.csv"  # 删除镜像
