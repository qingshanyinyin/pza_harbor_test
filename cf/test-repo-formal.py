...
# 记录文件
build_results_file = "./cf/build_results.csv" # build镜像
push_results_file = "./cf/push_results.csv"   # push镜像
pull_results_file = "./cf/pull_results.csv"   # pull镜像
delete_local_results_file = "./cf/delete_local_results.csv"  # 删除镜像
