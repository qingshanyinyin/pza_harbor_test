...
# lxy edit
repo_ref = "paddlepaddle"
repo_url = repo_address + repo_ref

# lxy edit
image_name = "paddlepaddle"

# 存放Dockerfile的工作目录
work_dir = "containers/nginx"

# 记录文件
build_results_file = "./pp/build_results.csv" # build镜像
push_results_file = "./pp/push_results.csv"   # push镜像
pull_results_file = "./pp/pull_results.csv"   # pull镜像
delete_local_results_file = "./pp/delete_local_results.csv"  # 删除镜像
...
def tag_container(iteration):
    images = "pytorch/pytorch:20.08-py3-cuda11"
    start_time = time()
